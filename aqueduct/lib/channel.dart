...
class ChallangeChannel extends ApplicationChannel
  ...
  Future prepare() async {
    ...
    final config = ChallangeConfiguration(options.configurationFilePath);
...
class ChallangeConfiguration extends Configuration {
  ChallangeConfiguration(String fileName) : super.fromFile(File(fileName));
